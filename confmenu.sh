...
function conf_squid () {
if [[ -d /etc/squid3/squid.conf ]]; then
echo -e "\033[1;31mREMOVENDO O SQUID\033[1;33m"
...
function socks_fun () {
if ps x | grep socks.py|grep -v grep 1>/dev/null 2>/dev/null; then
...
screen -dmS socks python /etc/socks.py $porta
echo -e "\n\033[1;32mPROXY SOCKS ATIVADO COM SUCESSO\033[1;33m"
sleep 3
menu
fi
}
...
ps x | grep socks.py|grep -v grep 1>/dev/null 2>/dev/null && sks='PARAR SOCKS' || sks='INICIAR SOCKS'
[[ -d /etc/squid3/squid.conf ]] && sqd='REMOVER SQUID' || sqd='INSTALAR SQUID'
...
echo ""
echo -e "\033[1;36m4\033[1;31m • \033[1;36m$sqd"
echo ""
echo -e "\033[1;36m5\033[1;31m • \033[1;36m$sks"
echo ""
echo -e "\033[1;36m6\033[1;31m • \033[1;36mOTIMIZAR"
echo ""
